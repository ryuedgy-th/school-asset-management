...
// POST /api/fm-assets/[assetCode]/upload - Upload images/documents for FM asset
export async function POST(
    ...
    try {
        ...
        const uploadDir = join(process.cwd(), 'public', 'fm-assets', asset.id.toString());
        ...
        for (const file of files) {
            try {
                ...
                // Store relative path
                const relativePath = `/fm-assets/${asset.id}/${filename}`;
