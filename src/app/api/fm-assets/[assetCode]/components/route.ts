...
// GET /api/fm-assets/[assetCode]/components - List asset components
export async function GET(
    ...
    try {
        ...
        // Find asset by assetCode to get its ID
...
// POST /api/fm-assets/[assetCode]/components - Add component to asset
