...
export default async function StationaryReturnsPage() {
                ...
                <div className="mb-8">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-slate-500 mt-1">Stationary item return records</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full">
                            <thead className="bg-slate-50 border-b border-slate-200">
                                <tr>
                                    <th className="px-6 py-4 text-left text-xs font-semibold text-slate-700 uppercase">Return No</th>
                                    <th className="px-6 py-4 text-left text-xs font-semibold text-slate-700 uppercase">Returned By</th>
                                    ...
                                    <th className="px-6 py-4 text-left text-xs font-semibold text-slate-700 uppercase">Reason</th>
                                    ...
                                    returns.map((returnItem) => (
                                        <tr key={returnItem.id} className="hover:bg-slate-50">
                                            <td className="px-6 py-4">
                                                <span className="font-mono text-sm">{returnItem.returnNo}</span>
                                            </td>
                                            <td className="px-6 py-4">
                                                <span className="text-sm">{returnItem.returnedBy.name}</span>
                                            </td>
                                            <td className="px-6 py-4">
                                                <span className="text-sm">{returnItem.department.name}</span>
                                            </td>
                                            <td className="px-6 py-4">
                                                <span className="text-sm font-semibold">{returnItem.items.length} items</span>
                                            </td>
                                            <td className="px-6 py-4">
                                            ...
                                            <td className="px-6 py-4">
                                                <span className="text-sm">{new Date(returnItem.createdAt).toLocaleDateString('th-TH')}</span>
                                            </td>
                                            <td className="px-6 py-4">
